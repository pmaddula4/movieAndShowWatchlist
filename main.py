...
def removeMovieShow(input):
    which = input("Type [w], [m], or [t] to remove from the watchlist, movie rankings, or show rankings: ")
    if which == "w":
        list = loadWatchlist()
        if list:
            for entry in list:
...
def renameMovieShow(input):
    which = input("Type [w], [m], or [t] to rename something from the watchlist, movie rankings, or show rankings: ")
    if which == "w":
        list = loadWatchlist()
        if list:
            for entry in list:
...
def updateOrder(input):
    which = input("Type [w], [m], or [t] to update the order of the watchlist, movie rankings, or show rankings: ")
    if which == "w":
        list = loadWatchlist()
        for entry in list:
            if input in list:
